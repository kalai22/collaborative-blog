...
private SessionFactory sessionFactory;
	...
	public List<User> getSuggestedUsers(User user) {
		...
		SQLQuery query=session.createSQLQuery("select * from kuser where username in (select username from kuser where username!=? minus (select from_id from friend where to_id=?"
